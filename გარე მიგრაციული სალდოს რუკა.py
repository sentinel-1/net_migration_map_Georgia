...
# - რუკის მონაცემები სახელმწიფო საზღვების შესახებ *(1:10m Cultural Vectors - Admin 0 – Countries - (latest) version 5.1.1)* მოპოვებულია 2022 წლის 11 ივნისს "Natural Earth-ის" ვებსაიტიდან: [naturalearthdata.com](https://www.naturalearthdata.com/)
# 
